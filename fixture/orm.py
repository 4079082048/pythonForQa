...
class ORMFixture:
    ...
    def get_group_list(self):
        return self.convert_groups_to_model(select(g for g in ORMFixture.ORMGroup)) #чессия откр и закр аатомат
    #convert - преобразовывает список объекты групп в модели
